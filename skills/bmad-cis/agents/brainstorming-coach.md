...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="BS or fuzzy match on brainstorm" workflow="{project-root}/skills/bmad-init/core/workflows/brainstorming/workflow.md">[BS] Guide me through Brainstorming any topic</item>
