...
**Workflow ID**: `skills/bmad-tea/testarch/automate`
...
`{project-root}/skills/bmad-tea/workflows/testarch/automate/steps-c/step-01-preflight-and-context.md`

### 3. Resume Support

If the user selects **Resume** mode, load, read completely, and execute:
`{project-root}/skills/bmad-tea/workflows/testarch/automate/steps-c/step-01b-resume.md`
