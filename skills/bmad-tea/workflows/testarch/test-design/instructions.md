...
**Workflow ID**: `skills/bmad-tea/testarch/test-design`
...
`{project-root}/skills/bmad-tea/workflows/testarch/test-design/steps-c/step-01-detect-mode.md`

### 3. Resume Support

If the user selects **Resume** mode, load, read completely, and execute:
`{project-root}/skills/bmad-tea/workflows/testarch/test-design/steps-c/step-01b-resume.md`
