...
**Workflow ID**: `skills/bmad-tea/testarch/ci`
...
`{project-root}/skills/bmad-tea/workflows/testarch/ci/steps-c/step-01-preflight.md`

### 3. Resume Support

If the user selects **Resume** mode, load, read completely, and execute:
`{project-root}/skills/bmad-tea/workflows/testarch/ci/steps-c/step-01b-resume.md`
