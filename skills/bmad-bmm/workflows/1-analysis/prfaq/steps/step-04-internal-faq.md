...
Append the Internal FAQ section to the output document. Update frontmatter: `status: "internal-faq"`, `stage: 4`, `stepsCompleted: ["step-01-ignition", "step-02-press-release", "step-03-customer-faq", "step-04-internal-faq"]`, `updated` timestamp.
...
Load and follow: `{project-root}/skills/bmad-bmm/workflows/1-analysis/prfaq/steps/step-05-verdict.md`
