...
Append the Customer FAQ section to the output document. Update frontmatter: `status: "customer-faq"`, `stage: 3`, `stepsCompleted: ["step-01-ignition", "step-02-press-release", "step-03-customer-faq"]`, `updated` timestamp.
...
Load and follow: `{project-root}/skills/bmad-bmm/workflows/1-analysis/prfaq/steps/step-04-internal-faq.md`
