...
- The `{project-root}/skills/bmad-init/core/tasks/workflow.md` framework will automatically:
...
3. **Load validation framework**: `{project-root}/skills/bmad-init/core/tasks/workflow.md`
