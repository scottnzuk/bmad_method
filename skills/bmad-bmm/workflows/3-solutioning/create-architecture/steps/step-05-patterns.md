...
- Read fully and follow: {project-root}/skills/bmad-init/core/workflows/advanced-elicitation/workflow.md with current patterns
...
- Read fully and follow: {project-root}/skills/bmad-init/core/workflows/party-mode/workflow.md with implementation patterns context
...
- Load `{project-root}/skills/bmad-bmm/workflows/3-solutioning/create-architecture/steps/step-06-structure.md`
