...
- Read fully and follow: {project-root}/skills/bmad-init/core/workflows/advanced-elicitation/workflow.md with the current design direction content
...
- Read fully and follow: {project-root}/skills/bmad-init/core/workflows/party-mode/workflow.md with the current design direction
...
- Load `{project-root}/skills/bmad-bmm/workflows/2-plan-workflows/create-ux-design/steps/step-10-user-journeys.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/skills/bmad-bmm/workflows/2-plan-workflows/create-ux-design/steps/step-10-user-journeys.md` to design user journey flows.
