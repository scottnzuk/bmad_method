...
# File References
nextStepFile: '{project-root}/skills/bmad-bmm/workflows/2-plan-workflows/create-prd/steps-c/step-06-innovation.md'
outputFile: '{planning_artifacts}/prd.md'
domainComplexityCSV: '{project-root}/skills/bmad-bmm/workflows/2-plan-workflows/create-prd/data/domain-complexity.csv'
