...
- IF A: Execute {project-root}/skills/bmad-init/core/workflows/advanced-elicitation/workflow.md
- IF P: Execute {project-root}/skills/bmad-init/core/workflows/party-mode/workflow.md
