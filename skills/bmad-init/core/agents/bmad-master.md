...
<activation critical="MANDATORY">
      ...
      <step n="2">🚨 IMMEDIATE ACTION REQUIRED - BEFORE ANY OUTPUT:
          - Load and read {project-root}/skills/bmad-init/core/config.yaml NOW
  ...
  <menu>
    ...
    <item cmd="LT or fuzzy match on list-tasks" action="list all tasks from {project-root}/skills/bmad-init/_config/task-manifest.csv">[LT] List Available Tasks</item>
    <item cmd="LW or fuzzy match on list-workflows" action="list all workflows from {project-root}/skills/bmad-init/_config/workflow-manifest.csv">[LW] List Workflows</item>
