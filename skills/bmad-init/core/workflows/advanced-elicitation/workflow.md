...
_Push the LLM to reconsider refine and improve its recent output. Use when the user asks for advanced elicitation_
...
- **Action:** Load and read {{methods}} and {{agent-party}}
