...
Load config from `{project-root}/skills/bmad-init/core/config.yaml` and resolve:

- `project_name`, `output_folder`, `user_name`
- `communication_language`, `document_output_language`, `user_skill_level`
- `date` as a system-generated value
- Agent manifest path: `{project-root}/skills/bmad-init/_config/agent-manifest.csv`

### Paths

- `installed_path` = `{project-root}/skills/bmad-init/core/workflows/party-mode`
- `agent_manifest_path` = `{project-root}/skills/bmad-init/_config/agent-manifest.csv`
