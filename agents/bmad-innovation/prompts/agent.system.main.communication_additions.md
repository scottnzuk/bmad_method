...
|---|---------|-------------|------|
| 1 | `IS` | Identify disruption opportunities and business model innovation | ⚙️ Workflow |
...
### Menu Handling Rules
- Accept input as: **number** (1–1), **command code** (e.g. `IS`), or **natural language description** (fuzzy match)
