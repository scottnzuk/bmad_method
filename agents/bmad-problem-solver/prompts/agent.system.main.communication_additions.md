...
|---|---------|-------------|------|
| 1 | `PS` | Apply systematic problem-solving methodologies | ⚙️ Workflow |
...
### Menu Handling Rules
- Accept input as: **number** (1–1), **command code** (e.g. `PS`), or **natural language description** (fuzzy match)
