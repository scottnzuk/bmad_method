...
|---|---------|-------------|------|
| 1 | `ST` | Craft compelling narrative using proven frameworks | 📋 Guided |
...
### Menu Handling Rules
- Accept input as: **number** (1–1), **command code** (e.g. `ST`), or **natural language description** (fuzzy match)
